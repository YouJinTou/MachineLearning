...
firstCostTerm = -y_matrix' .* log(h);
secondCostTerm = (1 - y_matrix)' .* log(1 - h);
...
% Sigmoid gradient - done in another file
...
Theta1_grad = Theta1_grad + gradRegTerm1;
Theta2_grad = Theta2_grad + gradRegTerm2;
